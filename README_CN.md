...
**效果。** 在 MCP 工具选择基准上，Hi-RAG 在五个主流模型、单轮与多轮设定下，准确率都稳定超过 Flat RAG，而 token 开销与 Flat RAG 相当 —— 远低于把整张 *Full Service* 列表喂给模型：

<sub>**S** = 单轮（Top-1 准确率），**M** = 多轮（Top-3 准确率）。Acc ↑ 越高越好；Avg Tokens ↓ 越低越好；**∆Acc** 为相对 Flat RAG 基线的提升。</sub>

| 模型 | 方法 | S·Acc (%) ↑ | S·Tokens ↓ | S·∆Acc | M·Acc (%) ↑ | M·Tokens ↓ | M·∆Acc |
|------|------|----------:|---------:|-------:|----------:|---------:|-------:|
| **Qwen3-8B** | Full Service | 38.8 | 423.5 | – | 11.7 | 739.0 | – |
| | Flat RAG | 72.6 | 170.8 | 基线 | 36.7 | 198.7 | 基线 |
| | **Hi-RAG（本方法）** | **78.1** | 176.5 | **+5.5** | **43.3** | 288.6 | **+6.6** |
| **Qwen3-32B** | Full Service | 47.8 | 610.0 | – | 21.7 | 1306.4 | – |
| | Flat RAG | 75.6 | 82.7 | 基线 | 38.3 | 134.4 | 基线 |
| | **Hi-RAG（本方法）** | **82.6** | 87.4 | **+7.0** | **48.3** | 132.9 | **+10.0** |
| **QwQ-32B** | Full Service | 45.3 | 597.5 | – | 20.0 | 1416.3 | – |
| | Flat RAG | 75.6 | 682.8 | 基线 | 28.3 | 1353.3 | 基线 |
| | **Hi-RAG（本方法）** | **82.6** | 621.4 | **+7.0** | **36.7** | 1573.6 | **+8.4** |
| **DeepSeek-V3** | Full Service | 41.3 | 167.2 | – | 6.7 | 271.2 | – |
| | Flat RAG | 75.1 | 111.3 | 基线 | 33.3 | 236.6 | 基线 |
| | **Hi-RAG（本方法）** | **82.6** | 111.4 | **+7.5** | **40.0** | 239.3 | **+6.7** |
| **GPT-4o-mini** | Full Service | 40.3 | 108.6 | – | 6.7 | 199.6 | – |
| | Flat RAG | 77.1 | 77.3 | 基线 | 28.3 | 159.2 | 基线 |
| | **Hi-RAG（本方法）** | **83.1** | 76.4 | **+6.0** | **31.7** | 168.6 | **+3.4** |
